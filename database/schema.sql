...
INSERT INTO inventory_transactions (ingredient_id, user_id, change_type, quantity, note) VALUES
(1, 1, 'RESTOCK', 8.00, 'Initial pantry stock'),
(2, 2, 'COOK', 400.00, 'Cooked Chicken Adobo'),
(3, 2, 'COOK', 4.00, 'Cooked Chicken Adobo'),
(4, 1, 'DEDUCT', 1.00, 'Spillage adjustment');

INSERT INTO notifications (user_id, type, message) VALUES
(NULL, 'LOW_STOCK', 'Low stock: Tomato (2 piece left, threshold 5)'),
(NULL, 'EXPIRY', 'Expired: Tomato has passed its expiry date');
