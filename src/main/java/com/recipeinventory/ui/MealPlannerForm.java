...
public class MealPlannerForm extends JPanel {
    ...
    public MealPlannerForm() {
        ...
        JButton addMeal = Ui.secondaryButton("Add Meal");
        JButton viewMeals = Ui.secondaryButton("View Meals");
        ...
        JPanel plans = Ui.card();
        plans.add(Ui.scrollPane(plansTable));
        JPanel meals = Ui.card();
        meals.add(Ui.scrollPane(mealsTable));
        center.add(plans);
        center.add(meals);
    ...
    private void addMeal() {
        ...
        try {
            ...
            JTextField date = Ui.searchField(14);
